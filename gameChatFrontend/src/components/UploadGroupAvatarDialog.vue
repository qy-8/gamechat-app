<script setup>
/**
 * @file UploadGroupAvatarDialog.vue
 * @description 用于上传和更换群组头像的对话框组件。
 * @component UploadGroupAvatarDialog
 * @property {boolean} visible - 控制对话框的显示与隐藏。
 * @emits update:visible - 当对话框可见状态改变时触发。
 * @emits upload-success - 当群组头像成功上传时触发，并传递新头像的URL。
 */
